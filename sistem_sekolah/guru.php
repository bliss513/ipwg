                    ...
                    <tbody>
                        ...
                        <tr onclick="window.location.href='basis_data/data_guru/ubah.php?id=<?php echo $hasil['id']; ?>'">
                            ...
                            <td class="action-container">
                                <a href="basis_data/data_guru/ubah.php?id=<?php echo $hasil['id']; ?>" style="color: #0000FF;">Ubah</a>
                                <a onclick="return confirm('Yakin ingin menghapus data ini?')" href="basis_data/data_guru/hapus.php?id=<?php echo $hasil['id']; ?>" style="color: #0000FF;">Hapus</a>
                            </td>
                        </tr>
                        <?php
                            }
